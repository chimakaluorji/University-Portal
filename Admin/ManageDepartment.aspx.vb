...
Partial Class Admin_ManageDepartment
    Inherits System.Web.UI.Page
    <WebMethod()> _
 <ScriptMethod()> _
    Public Shared Function InsertData(ByVal DeptName As String) As String
        ...
        DepartmentData.DeptName = DeptName

        ' call CreateSession API
        Dim CreateStatus As Integer = DepartmentDAL.CreateDepartment(DepartmentData)
        If CreateStatus = 1 Then
            msg = "The Department was created successfully."
        Else
            msg = "The Department was NOT created successfully."
        End If
        Return msg
    End Function
    <WebMethod()> _
...
<ScriptMethod()> _
    ...
    <WebMethod()> _
 <ScriptMethod()> _
    Public Shared Function GetDepartment(ByVal PID As String) As String
        Dim msg As String = String.Empty
        ...
        DepartmentData = DepartmentDAL.FindDepartmentByID(DeptID)
        msg = DepartmentData.DeptName
