<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="ManageProgramme.aspx.vb" Inherits="Admin_ManageProgramme" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Manage Programme</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover dataTables-example" id="editable1">
                                                ...
                                                <%
                                                    ...
                                                    RetDataSet = SSDDal.FindAllProgramme()
                                                %>
                                                <% For i = 0 To RetDataSet.Tables(0).Rows.Count - 1%>
                                                <tbody>
                                                    <tr class="gradeX">
                                                        <td><%= RetDataSet.Tables(0).Rows(i).Item("DeptName")%></td>
                                                        <td><%= RetDataSet.Tables(0).Rows(i).Item("ProgrammeName")%></td>
                                                        <td><a href='#myModal' data-toggle="modal" data-target="#myModal3" id='<%= RetDataSet.Tables(0).Rows(i).Item("ProgrammeID")%>'><i class="fa fa-check text-navy"></i></a></td>
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <asp:TextBox ID="txtProgramme" runat="server" CssClass="form-control" placeholder="New Programme"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <%-- <%
                                  Dim SSDDal1 As SessionSemesterDepartmentDAL = New SessionSemesterDepartmentDAL
                                  Dim RetDataSet1 As System.Data.DataSet = New System.Data.DataSet
                        
                                  RetDataSet1 = SSDDal.FindAllDepartment()
                                                %>--%>

                            <div class="form-group">
                                <label class="col-lg-3 control-label">New Dept.: </label>
                                <div class="col-lg-9">
                                    <asp:DropDownList ID="ddlDept1" runat="server" CssClass="form-control" DataSourceID="ObjSc" DataTextField="DeptName"
                                        DataValueField="DeptID" AppendDataBoundItems="true">
                                        <asp:ListItem>---Please Select---</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:ObjectDataSource ID="ObjSc" runat="server" SelectMethod="FindAllDepartment" TypeName="SessionSemesterDepartmentDAL"></asp:ObjectDataSource>
                                </div>
                            </div>
                            <%--<% 
                                ddlDept1.DataSource = RetDataSet1
                                ddlDept1.DataTextField = "DeptName"
                                ddlDept1.DataValueField = "DeptID"
                                ddlDept1.DataBind()
                                %>--%>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">New Prog.: </label>
                                <div class="col-lg-9">
                                    <asp:TextBox ID="txtProgramme1" runat="server" CssClass="form-control" placeholder="New Programme"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btnSave').click(function () {
                var Programme = $("[id*=txtProgramme]").val();
                var DeptID = $("[id*=ddlDept] option:selected").val();
                var SelectedDept = $("[id*=ddlDept]");
                ...
                if (DeptID != 0) {
                    if (Programme != '') {
                            $.ajax({
                                ...
                                url: "ManageProgramme.aspx/InsertData",
                                data: "{'DeptID':'" + DeptID + "','Programme':'" + Programme + "'}",
                                dataType: "json",
                                success: function (data) {
                                    ...
                                    if (obj != '') {
                                        ...
                                        $('#editable1').dataTable().fnAddData([$("[id*=ddlDept]").find("option:selected").text(), $("[id*=txtProgramme]").val(), ""]);
                                    }
                        ...
                        alert('Please fill the Programme to Continue')
                        return false;
                    }
                }
                else {
        ...
        $("a[data-toggle=modal]").click(function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ManageProgramme.aspx/GetProgramme",
                data: "{'PID':'" + essay_id + "'}",
                dataType: "json",
                success: function (data) {
                    var obj = data.d;
                    ...
                    if (obj != '') {
                        $("[id$='lblDepartment']").html(data.d[0]);
                        $("[id$='txtProgramme1']").val(data.d[1]);
        ...
        $(function () {
            $('#btnEdit').click(function () {
                var EditProgramme = $("[id*=txtProgramme1]").val();
                ...
                if (EditProgramme != '') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ManageProgramme.aspx/UpdateData",
                        data: "{'EProgramme':'" + EditProgramme + "','EPID':'" + EditPID + "'}",
                        dataType: "json",
                        success: function (data) {
                            var obj = data.d;
                        ...
                        error: function (result) {
                            alert('The Programme was NOT Updated successfully.');
                        }
                    });
                }
                else {
