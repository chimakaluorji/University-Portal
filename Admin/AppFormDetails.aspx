<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AppFormDetails.aspx.vb" Inherits="Admin_AppFormDetails" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="new_step-content" id="Step4" style="display: none;">
                             <div class="col-lg-12" id="successConfirm" style="display: none;">
                            ...
                            <div>&nbsp;</div>
                            <div class="form-group">
                                <input type="button" value="Confirm Application" id="btnConfirm" class="btn btn-success-primary" style="display: none;" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                url: "AppFormDetails.aspx/FindAllApplicationByApplicationNumber",
                ...
                success: function (data) {
                    ...
                    $("[id*=txtExamNumberOne]").html(data.d[0].Subject1);
            ...
            $('#BioData4').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //Checking if application have being confirmed
                        var confirmed = data.d[0].Confirmed
            ...
            $('#btnConfirm').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AppFormDetails.aspx/ConfirmedAppForm",
                    data: "{'ApplicationNumber':'" + ApplicationNumber + "'}",
                    dataType: "json",
                    success: function (data) {
