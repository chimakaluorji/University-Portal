<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminRegisterSummerCourses.aspx.vb" Inherits="Admin_AdminRegisterSummerCourses" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Manage Summer Courses</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
        ...
        $(document).ready(function () {
            ...
            if (delconfirm == 'YES') {
                ...
                $.ajax({
                    ...
                    url: "AdminRegisterSummerCourses.aspx/GetAllCourses",
                    ...
                    success: function (data) {
                        ...
                        $('#btnDelete').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "AdminRegisterSummerCourses.aspx/DeleteCourse",
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterSummerCourses.aspx/GetCourse",
                        ...
                        $('#btnRegister').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "AdminRegisterSummerCourses.aspx/RegisterCourses",
            ...
            $('#btnSearch2').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterSummerCourses.aspx/GetAllAddCourses",
