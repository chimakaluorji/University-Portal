<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="ManageSession.aspx.vb" Inherits="Admin_ManageSession" %>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered table-hover dataTables-example" id="editable1">
                                                            <thead>
                                                                ...
                                                                RetDataSet = SSDDal.FindAllSessions()
                                                                %>
                                                                <% For i = 0 To RetDataSet.Tables(0).Rows.Count - 1%>
                                                                <tbody>
                                                                <tr class="gradeX">
                                                                    <td><%= RetDataSet.Tables(0).Rows(i).Item("SessionName")%></td>
                                                                    <td><a href='#myModal' data-toggle="modal" data-target="#myModal3" id="<%= RetDataSet.Tables(0).Rows(i).Item("SessionID")%>"><i class="fa fa-check text-navy"></i></a></td>
                                            ...
                                            <div class="ibox-content">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group"><label class="col-lg-3 control-label">Session Name: </label>
                                                             <div class="col-lg-9">
                                                                <asp:TextBox ID="txtSession" runat="server" CssClass="form-control" placeholder="Session Name" style="width:300px;"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated flipInY">
                                        ...
                                        <div class="modal-body">
                                            <div class="ibox-content">
                                                    <div class="form-horizontal">
                                                       <div class="form-group"><label class="col-lg-4 control-label">New Session Name: </label>
                                                             <div class="col-lg-8">
                                                                <asp:TextBox ID="txtSession1" runat="server" CssClass="form-control" style="width:300px;"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    $(function () {
        $('#btnSave').click(function () {
            var SessionName = $("[id*=txtSession]").val();

            if (SessionName != '') {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ManageSession.aspx/InsertData",
                    ...
                    success: function (data) {
                        ...
                        if (obj != '') {
                            ...
                            $('#editable1').dataTable().fnAddData([$("[id*=txtSession]").val(),""]);
                        }
                    ...
                    error: function (result) {
                        alert('The Session was NOT created successfully.');
                    }
                });
            }
            else {
                alert('Please fill the Session Name to Continue')
                return false;
            }
        })
    });
    ...
    $("a[data-toggle=modal]").click(function () {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "ManageSession.aspx/GetSessionName",
            data: "{'PID':'" + essay_id + "'}",
            dataType: "json",
            success: function (data) {
                var obj = data.d;
    ...
    $(function () {
        $('#btnEdit').click(function () {
            var EditSessionName = $("[id*=txtSession1]").val();
            ...
            if (EditSessionName != '') {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ManageSession.aspx/UpdateData",
                    data: "{'ESessionName':'" + EditSessionName + "','EPID':'" + EditPID + "'}",
                    dataType: "json",
                    success: function (data) {
                        var obj = data.d;
                    ...
                    error: function (result) {
                        alert('The Session was NOT Updated successfully.');
                    }
                });
            }
            else {
        ...
        $('#btnDelete').click(function () {
            var EditPID = essay_id;
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ManageSession.aspx/DeleteData",
                    data: "{'EPID':'" + EditPID + "'}",
                    dataType: "json",
                    success: function (data) {
                        var obj = data.d;
