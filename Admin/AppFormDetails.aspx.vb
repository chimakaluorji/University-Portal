...
Imports System.Web
Imports System.IO
Partial Class Admin_AppFormDetails
...
<ScriptMethod()> _
    ...
    <WebMethod()> _
<ScriptMethod()> _
    Public Shared Function ConfirmedAppForm(ByVal ApplicationNumber As String) As String
        ...
        success = QPDal.ConfirmedAppForm(ApplicationNumber)
