<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="ManageLevel.aspx.vb" Inherits="Admin_ManageLevel" %>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover dataTables-example" id="editable1">
                                                ...
                                                <%
                                                    ...
                                                    RetDataSet = SSDDal.FindAllLevel()
                                                %>
                                                <% For i = 0 To RetDataSet.Tables(0).Rows.Count - 1%>
                                                <tbody>
                                                    <tr class="gradeX">
                                                        <td><%= RetDataSet.Tables(0).Rows(i).Item("LevelName")%></td>
                                                        <td><a href='#myModal' data-toggle="modal" data-target="#myModal3" id='<%= RetDataSet.Tables(0).Rows(i).Item("LevelID")%>'><i class="fa fa-check text-navy"></i></a></td>
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <asp:TextBox ID="txtLevel" runat="server" CssClass="form-control" placeholder="100"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content animated flipInY">
                ...
                <div class="modal-body">
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-4 control-label">New Level: </label>
                                <div class="col-lg-8">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btnSave').click(function () {
                var LevelName = $("[id*=txtLevel]").val();

                if (LevelName != '') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ManageLevel.aspx/InsertData",
                        ...
                        error: function (result) {
                            alert('The Level was NOT created successfully.');
                        }
                    });
                }
                else {
                    alert('Please fill the Level to Continue')
                    return false;
                }
            })
        });
        ...
        $(function () {
            $('#btnEdit').click(function () {
                var EditLevelName = $("[id*=txtLevel1]").val();
                ...
                if (EditLevelName != '') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ManageLevel.aspx/UpdateData",
                        data: "{'ELevel':'" + EditLevel + "','EPID':'" + EditPID + "'}",
                        dataType: "json",
                        success: function (data) {
                            var obj = data.d;
                        ...
                        error: function (result) {
                            alert('The Level was NOT Updated successfully.');
                        }
                    });
                }
                else {
