<%@ Page Language="VB"  MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminUploadExtraYearResult.aspx.vb" Inherits="Admin_AdminUploadExtraYearResult" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <link href="css/plugins/steps/jquery.steps.css" rel="stylesheet">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Manage Extra Year Result</h2>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <strong>Manage Extra Year Result</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Manage Extra Year Result</h5>
                                        <br />
                                      ...
                                      <div id="Course" style="display:none;">
                                       ...
                                       <div id="CourseCode" style="display:none;">
                                        ...
                                        <div id="Result" style="display:none;">
                                            ...
                                            <div>&nbsp;</div>
                                             <div class="modal-footer">
                                                <input type="button" id="btnShowResult" value="Show Uploaded Result" class="btn btn-primary" />
                                            </div>
                                       </div>
        ...
        $(document).ready(function () {
            ...
            $(document).on("change", "[id*=ddlEntryLevel]", function () {
                ...
                $.ajax({
                    ...
                    url: "AdminUploadExtraYearResult.aspx/GetCourse",
                        ...
                        $('input[type=checkbox]').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "AdminUploadExtraYearResult.aspx/GetCourseCode",
                                            ...
                                            $("input:checked").each(function () {
                                                    ...
                                                    if (courseCode != '0') {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            contentType: "application/json; charset=utf-8",
                                                            url: "AdminUploadExtraYearResult.aspx/UploadResult",
                                                ...
                                                $('#btnShowResult').click(function () {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "AdminUploadExtraYearResult.aspx/FindDepartmentalResultHeader",
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "AdminUploadExtraYearResult.aspx/findDepartmentalResult",
                                                        data: "{'Session':'" + newSession + "','Semester':'" + SemesterName + "','Level':'" + newLevel + "'}",
                                                        dataType: "json",
                                                        success: function (data) {
