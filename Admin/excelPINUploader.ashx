...
Public Class excelPINUploader : Implements IHttpHandler
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            Dim dirFullPath As String = HttpContext.Current.Server.MapPath("~/PINExcelFiles/")
            Dim files As String()
            ...
            For Each s As String In context.Request.Files
                ...
                If Not String.IsNullOrEmpty(fileName) Then
                    ...
                    str_image = Convert.ToString("HP_EXCEL_" + numFiles.ToString()) & fileExtension
                    pathToSave_100 = HttpContext.Current.Server.MapPath("~/PINExcelFiles/") & str_image
                    file.SaveAs(pathToSave_100)
                End If
            Next
            
            context.Response.Write("~/PINExcelFiles/" & str_image)
