<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="ManageSemester.aspx.vb" Inherits="Admin_ManageSemester" %>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover dataTables-example" id="editable1">
                                                ...
                                                <%
                                                    ...
                                                    RetDataSet = SSDDal.FindAllSemesters()
                                                %>
                                                <% For i = 0 To RetDataSet.Tables(0).Rows.Count - 1%>
                                                <tbody>
                                                    <tr class="gradeX">
                                                        <td><%= RetDataSet.Tables(0).Rows(i).Item("SemesterName")%></td>
                                                        <td><a href='#myModal' data-toggle="modal" data-target="#myModal3" id='<%= RetDataSet.Tables(0).Rows(i).Item("SemesterID")%>'><i class="fa fa-check text-navy"></i></a></td>
                    ...
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <asp:TextBox ID="txtSemester" runat="server" CssClass="form-control" placeholder="Semester Name" Style="width: 300px;"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content animated flipInY">
                <div class="modal-header">
                    ...
                    <div>
                        ...
                        <asp:Label ID="lblError2" runat="server" Text="" ForeColor="Green" Font-Size="15px" Font-Bold="true"></asp:Label>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="ibox-content">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-4 control-label">New Semester: </label>
                                <div class="col-lg-8">
                                    <asp:TextBox ID="txtSemester1" runat="server" CssClass="form-control" Style="width: 300px;"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btnSave').click(function () {
                var SemesterName = $("[id*=txtSemester]").val();

                if (SemesterName != '') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ManageSemester.aspx/InsertData",
                        ...
                        success: function (data) {
                            ...
                            if (obj != '') {
                                ...
                                $('#editable1').dataTable().fnAddData([$("[id*=txtSemester]").val(), ""]);
                            }
                        ...
                        error: function (result) {
                            alert('The Semester was NOT created successfully.');
                        }
                    });
                }
                else {
                    alert('Please fill the Semester Name to Continue')
                    return false;
                }
            })
        });
        ...
        $("a[data-toggle=modal]").click(function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ManageSemester.aspx/GetSemesterName",
                data: "{'PID':'" + essay_id + "'}",
                dataType: "json",
                success: function (data) {
                    var obj = data.d;
        ...
        $(function () {
            $('#btnEdit').click(function () {
                var EditSemesterName = $("[id*=txtSemester1]").val();
                ...
                if (EditSemesterName != '') {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ManageSemester.aspx/UpdateData",
                        data: "{'ESessionName':'" + EditSemesterName + "','EPID':'" + EditPID + "'}",
                        dataType: "json",
                        success: function (data) {
                            var obj = data.d;
                        ...
                        error: function (result) {
                            alert('The Semester was NOT Updated successfully.');
                        }
                    });
                }
                else {
        ...
        $(function () {
            $('#btnDelete').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "ManageSemester.aspx/DeleteData",
                    data: "{'EPID':'" + EditPID + "'}",
                    dataType: "json",
                    success: function (data) {
                        var obj = data.d;
                    ...
                    error: function (result) {
                        alert('The Session was NOT Deleted successfully.');
                    }
                });
            })
        });
