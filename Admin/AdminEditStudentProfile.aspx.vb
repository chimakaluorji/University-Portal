...
Partial Class Admin_AdminEditStudentProfile
...
<ScriptMethod()> _
    Public Shared Function GetStudentRegNo(ByVal ERegNumberSearch As String) As Array
        ...
        If StudentData IsNot Nothing Then
            ...
            msg(7) = StudentData.StateID
            msg(8) = StudentData.LGAID
            msg(9) = StudentData.HomeAddress
            msg(10) = StudentData.PhoneNumber
            msg(11) = StudentData.Email
            msg(12) = StudentData.NOKName
            msg(13) = StudentData.SessionID
            msg(14) = StudentData.SemesterID
            msg(15) = StudentData.LevelID
 ...
 <ScriptMethod()> _
  ...
  <ScriptMethod()> _
    Public Shared Function InsertData(ByVal ERegNumber As String, ByVal EMidleName As String, ByVal ESurname As String, ByVal EFirstname As String, _
                                      ...
                                      ByVal Epass As String, ByVal EsaltKey As String) As String
