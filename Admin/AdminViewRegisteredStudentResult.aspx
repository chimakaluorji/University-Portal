<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminViewRegisteredStudentResult.aspx.vb" Inherits="Admin_AdminViewRegisteredStudentResult" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <link href="css/plugins/steps/jquery.steps.css" rel="stylesheet">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>View Registered Student Result</h2>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <strong>View Registered Student Result</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>View Registered Student Result</h5>
                                        <br />
        ...
        $(document).ready(function () {
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    ...
                    url: "AdminViewRegisteredStudentResult.aspx/GetResult",
                    data: "{'regNumber':'" + regNumber + "','Session':'" + newSession + "','Semester':'" + newSemester + "'}",
                    dataType: "json",
                    success: function (data) {
                        ...
                        $('#Search').hide();
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                $('#editable1').dataTable().fnAddData([data.d[i].CourseName, data.d[i].CourseCode, data.d[i].CreditUnit, data.d[i].Score, data.d[i].Grade, data.d[i].Remark]);
                            }
