<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Admin/AdminMasterPage.master" CodeFile="AdminRegisterStudentCourses.aspx.vb" Inherits="Admin_AdminRegisterStudentCourses" %>
        ...
        $(document).ready(function () {
            ...
            if (delconfirm == 'YES') {
                ...
                $.ajax({
                    ...
                    url: "AdminRegisterStudentCourses.aspx/GetAllCourses",
                    ...
                    success: function (data) {
                        ...
                        $('#btnDelete').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "AdminRegisterStudentCourses.aspx/DeleteCourse",
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterStudentCourses.aspx/GetCourse",
            ...
            $('#btnSearch2').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterStudentCourses.aspx/GetAllAddCourses",
