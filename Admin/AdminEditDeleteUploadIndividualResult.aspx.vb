...
Partial Class Admin_AdminEditDeleteUploadIndividualResult
    ...
    Public Shared Function GetStudent(ByVal SessionName As String, ByVal SemesterName As String, ByVal LevelName As String) As ArrayList
        ...
        Dim RetDat As DataSet = SeDal.FindAllStudentForResultBySessionIDSemesterIDLevelID(SessionName, SemesterName, LevelName)
        ...
        For Each row As DataRow In RetDat.Tables(0).Rows
            ...
            QueueList.Add(New FindAllStudentArrayData1(row1, row2, row3))
        Next
...
End Class
Public Class FindAllStudentArrayData1
