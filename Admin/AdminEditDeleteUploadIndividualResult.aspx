<%@ Page Language="VB"  MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminEditDeleteUploadIndividualResult.aspx.vb" Inherits="Admin_AdminEditDeleteUploadIndividualResult" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btnSearch').click(function () {
            ...
            var SessionName = $("[id*=ddlSession]").find("option:selected").text()
            var SemesterName = $("[id*=ddlSemester]").find("option:selected").text()
            var LevelName = $("[id*=ddlEntryLevel]").find("option:selected").text()
