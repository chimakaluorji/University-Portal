...
Partial Class Admin_AdminEditDeleteUploadIndividualSummerResult
    ...
    Public Shared Function GetStudent(ByVal SessionName As String, ByVal SemesterName As String, ByVal LevelName As String) As ArrayList
        ...
        Dim RetDat As DataSet = SeDal.FindAllStudentForResultBySessionIDSemesterIDLevelID_Summer(SessionName, SemesterName, LevelName)
        ...
        For Each row As DataRow In RetDat.Tables(0).Rows
            ...
            QueueList.Add(New FindAllStudentArrayData4(row1, row2, row3))
        Next
    ...
    End Function
End Class
Public Class FindAllStudentArrayData4
