<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminCreateStudentProfile.aspx.vb" Inherits="Admin_AdminCreateStudentProfile" %>
                    ...
                    <div class="ibox-content" id="mainPage" style="display:none;">
                            ...
                            <div class="new_step-content" style="background-color:white;">
                                    <div style="float:right;">
                                        ...
                                        <%--<input type="button" value="Save" id="btnSaveTest" class="btn btn-success-primary"/>--%>
...
<script type="text/javascript">
    ...
    $(function () {
        $(document).on("change", "[id*=ddlState]", function () {
            ...
            $.ajax({
                ...
                url: "AdminCreateStudentProfile.aspx/GetLGA",
    ...
    //            type: "POST",
    //            contentType: "application/json; charset=utf-8",
    //            url: "AdminCreateStudentProfile.aspx/GetProgramme",
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "AdminCreateStudentProfile.aspx/InsertData",
        ...
        $('#btnSearch').click(function () {
            ...
            if (RegNumberSearch != '') {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminCreateStudentProfile.aspx/GetStudentRegNo",
                    ...
                    success: function (data) {
                        ...
                        //Loading student data into reg no, first name and surname label
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                //$("[id*=ddlProgramme]").append($("<option></option>").val(data.d[i].ProgrammeID).html(data.d[i].Programme));
