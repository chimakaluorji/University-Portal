<%@ Page Language="VB"  MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminRegisterExtraYearCourses.aspx.vb" Inherits="Admin_AdminRegisterExtraYearCourses" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <link href="css/plugins/steps/jquery.steps.css" rel="stylesheet">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Manage Extra Year Courses</h2>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <strong>Manage Extra Year Courses</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Manage Extra Year Courses</h5>
                                        <br />
        ...
        $(document).ready(function () {
            ...
            if (delconfirm == 'YES') {
                ...
                $.ajax({
                    ...
                    url: "AdminRegisterExtraYearCourses.aspx/GetAllCourses",
                    ...
                    success: function (data) {
                        ...
                        $('#btnDelete').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "AdminRegisterExtraYearCourses.aspx/DeleteCourse",
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterExtraYearCourses.aspx/GetCourse",
                        ...
                        $('#btnRegister').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "AdminRegisterExtraYearCourses.aspx/RegisterCourses",
            ...
            $('#btnSearch2').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminRegisterExtraYearCourses.aspx/GetAllAddCourses",
                ...
                $('#btnAdd').click(function () {
                    $("input:checked").each(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "AdminRegisterStudentCourses.aspx/RegisterCourses",
