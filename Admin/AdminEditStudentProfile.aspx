<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master"AutoEventWireup="false" CodeFile="AdminEditStudentProfile.aspx.vb" Inherits="Admin_AdminEditStudentProfile" %>
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="col-lg-10" id="success" style="display:none;">
                                          <div class="alert alert-success" >
                                                 The Student Profile was successfully Created.
                                           </div>
                                          </div>
                        ...
                        <div class="form-group">
                                              <div class="col-lg-12" style="color:#F25926; font-size:15px; display: none; text-align:center;" id="spinnerSave" >
                            ...
                            <div class="new_step-content" id="Step1">
                                <div class="text-center m-t-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                             <asp:DropDownList ID="ddlLGA" runat="server" AppendDataBoundItems="True" DataSourceID="odsLGA"
                                                            DataTextField="LGAName" DataValueField="LGAID" CssClass="form-control">
                                                          <asp:ListItem Value="0">--Please Select--</asp:ListItem>
                                                      </asp:DropDownList>
                                             <asp:ObjectDataSource ID="odsLGA" runat="server" EnableCaching="True"
                                                           SelectMethod="FindAllLGAs" TypeName="CountryStateLGADAL">
                                                      </asp:ObjectDataSource>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                            ...
                            <div class="new_step-content" id="Step3" style="display:none;">
                                <div class="text-center m-t-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                             <asp:DropDownList ID="ddlProgramme" runat="server" AppendDataBoundItems="True" DataSourceID="odsProgramme"
                                                            DataTextField="ProgrammeName" DataValueField="ProgrammeID" CssClass="form-control">
                                                          <asp:ListItem Value="0">--Please Select--</asp:ListItem>
                                                      </asp:DropDownList>
                                            <asp:ObjectDataSource ID="odsProgramme" runat="server" EnableCaching="True"
                                                           SelectMethod="FindAllProgramme" TypeName="SessionSemesterDepartmentDAL">
                                                      </asp:ObjectDataSource>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>--%>
...
<script type="text/javascript">
    ...
    $(function () {
        $('#btnNext').click(function () {
            ...
            var NoKHomeAddress = 'YES'//$("[id*=txtNoKHomeAddress]").val();
            var NokPhoneNumber = 'YES'//$("[id*=txtNokPhoneNumber]").val();

            //Step Three
            var SessionID = $("[id*=ddlSession]").find("option:selected").val()
            var SemesterID = $("[id*=ddlSemester]").find("option:selected").val()
            var DepartmentID = '1'//$("[id*=ddlDepartment]").find("option:selected").val()
            var ProgrammeID = '1'//$("[id*=ddlProgramme]").find("option:selected").val()
    ...
    $(function () {
        $('#btnSave').click(function () {
            ...
            var ProgrammeID = '0'//$("[id*=ddlProgramme]").find("option:selected").val()
            var LevelID = $("[id*=ddlLevel]").find("option:selected").val()
            ...
            //Step Six
            var pass = 'krcFAS/8yd2hQJK/KzdRr/AHUsmH9cuZIOyRvXoCVLx1GGJfz1kT3yhCRJhrjcnpBcs08tz6a2QMH3k4JYs/gA==';
            var saltKey = 'NgBvOtDm8kKt5CkXuErbQycE+cqyo3lDL8BSz6f20w0=';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "AdminEditStudentProfile.aspx/InsertData",
        ...
        $('#btnSearch').click(function () {
            ...
            if (RegNumberSearch != '') {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AdminEditStudentProfile.aspx/GetStudentRegNo",
                    ...
                    success: function (data) {
                        ...
                        if (obj != '') {
                            ...
                            $("[id$='txtSurname']").val(data.d[1]);
                            $("[id$='txtFirstname']").val(data.d[2]);

                            $("[id*=txtmidleName]").val(data.d[3]);
                            $("[id*=txtMotherMaidenName]").val(data.d[4]);
                            $("#DoB").val(data.d[5]);
                            $('#<%=rdoGender.ClientID%>').find("input[value='" + data.d[6] + "']").attr("checked", "checked");
                            $("[id*=ddlState]").val(data.d[7])
                            $("[id*=ddlLGA]").val(data.d[8])

                            //Step Two 
                            $("[id*=txtHomeAddress]").val(data.d[9]);
                            $("[id*=txtPhoneNumber]").val(data.d[10]);
                            $("[id*=txtEmailAddress]").val(data.d[11]);
                            $("[id*=txtNoKName]").val(data.d[12]);
                           

                            //Step Three
                            $("[id*=ddlSession]").val(data.d[13])
                            $("[id*=ddlSemester]").val(data.d[14])
                            $("[id*=ddlLevel]").val(data.d[15])

                            //Step Four
                            $("[id*=txtPs]").val(data.d[16]);
                            $("#DPsFrom").val(data.d[17]);
                            $("#DPsTo").val(data.d[18]);
                            $("[id*=txtSs]").val(data.d[19]);
                            $("#DSsFrom").val(data.d[20]);
                            $("#DSsTo").val(data.d[21]);
