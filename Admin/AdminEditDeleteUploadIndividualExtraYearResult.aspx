<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminEditDeleteUploadIndividualExtraYearResult.aspx.vb" Inherits="Admin_AdminEditDeleteUploadIndividualExtraYearResult" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <link href="css/plugins/steps/jquery.steps.css" rel="stylesheet">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Edit, Detele and Upload Extra Year Individual Result</h2>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <strong>Edit, Detele and Upload Extra Year Individual Result</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Edit, Detele and Upload Extra Year Individual Result</h5>
                                        <br />
    ...
    $(document).ready(function () {
        ...
        $('#btnSearch').click(function () {
            ...
            $.ajax({
                ...
                url: "AdminEditDeleteUploadIndividualExtraYearResult.aspx/GetStudent",
                ...
                success: function (data) {
                    ...
                    $("a[data-toggle=modal]").click(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "AdminEditDeleteUploadIndividualExtraYearResult.aspx/GetStudentRegNo",
