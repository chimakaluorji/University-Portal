...
Public Class adminFileUploader : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            Dim dirFullPath As String = HttpContext.Current.Server.MapPath("~/AdminPassport/")
            Dim files As String()
            ...
            For Each s As String In context.Request.Files
                ...
                If Not String.IsNullOrEmpty(fileName) Then
                    fileExtension = Path.GetExtension(fileName)
                    str_image = "SHT_PHOTO_ADMIN_" + numFiles.ToString() + fileExtension
                    Dim pathToSave As String = HttpContext.Current.Server.MapPath("~/AdminPassport/") + str_image
            ...
            context.Response.Write("~/AdminPassport/" & str_image)
