<%@ Page Language="VB" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="false" CodeFile="AdminUploadSummerResult.aspx.vb" Inherits="Admin_AdminUploadSummerResult" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Manage Summer Result</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
        ...
        $(document).ready(function () {
            ...
            $(document).on("change", "[id*=ddlEntryLevel]", function () {
                ...
                $.ajax({
                    ...
                    url: "AdminUploadSummerResult.aspx/GetCourse",
                        ...
                        $('input[type=checkbox]').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "AdminUploadSummerResult.aspx/GetCourseCode",
                                            ...
                                            $("input:checked").each(function () {
                                                    ...
                                                    if (courseCode != '0') {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            contentType: "application/json; charset=utf-8",
                                                            url: "AdminUploadSummerResult.aspx/UploadResult",
                                                ...
                                                $('#btnShowResult').click(function () {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "AdminUploadSummerResult.aspx/FindDepartmentalResultHeader",
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        contentType: "application/json; charset=utf-8",
                                                        url: "AdminUploadSummerResult.aspx/findDepartmentalResult",
                                                        data: "{'Session':'" + newSession + "','Semester':'" + SemesterName + "','Level':'" + newLevel + "'}",
                                                        dataType: "json",
                                                        success: function (data) {
