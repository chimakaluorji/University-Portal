...
Partial Class Students_StudentRegisterExtraYearCourses
    ...
    Public Shared Function GetCourse(ByVal regNumber As String, ByVal SemesterID As String, ByVal Session As String, ByVal Semester As String) As ArrayList
        ...
        returnArray = DataDal.FindAllCoursesByRegNoSession_ExtraYear(newRegNumber, Session, Semester, studentData.LevelName)
    ...
    Public Shared Function RegisterCourses(ByVal CourseID As String, ByVal regNumber As String, ByVal Session As String, ByVal Semester As String) As String
        ...
        ReturnValue = DataDal.CreateCourseRegistration_Portal_ExtraYear(CourseIDInt, newRegNumber, Session, Semester, studentData.LevelName)
    ...
    Public Shared Function DeleteCourse(ByVal CourseID As String) As String
        ...
        ReturnValue = DataDal.DeletCourses_Portal_ExtraYear(CourseIDInt)
    ...
    Public Shared Function GetAllAddCourses(ByVal regNumber As String, ByVal SemesterID As String, ByVal Session As String, ByVal Semester As String) As ArrayList
        ...
        QueueList = DataDal.FindAllAddCoursesBySessionID_Portal_ExtraYear(newRegNumber, Session, Semester, LevelName, SemesterIDInt, LevelIDInt)
    ...
    Public Shared Function GetAllCourses(ByVal regNumber As String, ByVal Session As String, ByVal Semester As String) As ArrayList
        ...
        QueueList = DataDal.FindAllCoursesByRegNoSession_ExtraYear(newRegNumber, Session, Semester, LevelName)
    ...
    Public Shared Function GCM_Send(ByVal regNumber As String) As String
        ...
        Dim msg As String = FullName & " with Reg. Number " & newRegNumber & " have a problem while Registering his/her Extra Year Courses. Call him/her with this Phone Number " & PhoneNumber
