...
Partial Class Students_StudentSummerResult
    ...
    Public Shared Function InsertData(ByVal RegistrationNumber As String, ByVal PIN As String, ByVal SessionID As String, ByVal SemesterID As String) As String
        ...
        Dim RegNumber As String = IEncrypt.Decrypt(RegNumber, "123456789")
    ...
    Public Shared Function FindAllResult(ByVal RegistrationNumber As String, ByVal PIN As String, ByVal SessionName As String, ByVal SemesterName As String, ByVal SessionID As String, ByVal SemesterID As String) As ArrayList
        ...
        Dim RetValue1 As String() = LoadUploadResultDAL.LoadingResult_Summer(LoadUploadResultData)
        ...
        Msg = UploadResultDAL.FindAllResultByRegNumber_Load_Summer(SessionName, SemesterName, LevelName, RegNumber)
    ...
    Public Shared Function GCM_Send(ByVal regNumber As String) As String
        ...
        Dim msg As String = FullName & " with Reg. Number " & newRegNumber & " have a problem while checking his/her Summer result. Call him/her with this Phone Number " & PhoneNumber
