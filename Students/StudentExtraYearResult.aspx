<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Students/StudentMasterPage.master" CodeFile="StudentExtraYearResult.aspx.vb" Inherits="Students_StudentExtraYearResult" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    ...
                    url: "StudentExtraYearResult.aspx/InsertData",
                            ...
                            if (check != '') {
                                ...
                                if (retMsg == 'Active') {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                                        url: "StudentExtraYearResult.aspx/FindAllResult",
            ...
            $('#btnPrintResult').click(function () {
                ...
                return popitup('PrintResult/PrintStudentExtraYearResult.aspx?regNo=' + regNumber1 + '&SessionName=' + newSession1 + '&SemesterName=' + newSemester1);
            })
        ...
        function GCM_Send() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "StudentExtraYearResult.aspx/GCM_Send",
