<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/Students/StudentMasterPage.master" CodeFile="StudentSummerResult.aspx.vb" Inherits="Students_StudentSummerResult" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    ...
                    url: "StudentSummerResult.aspx/InsertData",
                            ...
                            if (check != '') {
                                ...
                                if (retMsg == 'Active') {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                                        url: "StudentSummerResult.aspx/FindAllResult",
            ...
            $('#btnPrintResult').click(function () {
                ...
                return popitup('PrintResult/PrintStudentSummerResult.aspx?regNo=' + regNumber1 + '&SessionName=' + newSession1 + '&SemesterName=' + newSemester1);
            })
        ...
        function GCM_Send() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "StudentSummerResultStudentSummerResult.aspx/GCM_Send",
