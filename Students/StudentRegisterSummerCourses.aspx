<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Students/StudentMasterPage.master" CodeFile="StudentRegisterSummerCourses.aspx.vb" Inherits="Students_StudentRegisterSummerCourses" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (delconfirm == 'YES') {
                ...
                $.ajax({
                    ...
                    url: "StudentRegisterSummerCourses.aspx/GetAllCourses",
                    ...
                    success: function (data) {
                        ...
                        $('#btnDelete').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "StudentRegisterSummerCourses.aspx/DeleteCourse",
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "StudentRegisterSummerCourses.aspx/GetCourse",
                        ...
                        $('#btnRegister').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "StudentRegisterSummerCourses.aspx/RegisterCourses",
            ...
            $('#btnSearch2').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "StudentRegisterSummerCourses.aspx/GetAllAddCourses",
        ...
        function GCM_Send() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "StudentRegisterSummerCourses.aspx/GCM_Send",
