...
Partial Class Students_Default2
...
<ScriptMethod()> _
 ...
 <ScriptMethod()> _
    ...
    <WebMethod()> _
  <ScriptMethod()> _
    Public Shared Function InsertData(ByVal ERegNumber As String, ByVal ESurname As String, ByVal EFirstname As String, ByVal EMidleName As String, _
                                      ...
                                      ByVal EDPsFrom As String, ByVal EDPsTo As String, ByVal DSsFrom As String, ByVal EDSsTo As String, ByVal EPhotoUrl As String) As String
        ...
        studentData.SessionID = ESessionID
        studentData.SemesterID = ESemesterID
        studentData.DepartmentID = EDepartmentID
        studentData.ProgrammeID = EProgrammeID
        studentData.LevelID = ELevelID
        studentData.LPS = EPs
        ...
        If CreateStatus = 1 Then
            msg = "The Student Profile was created successfully."
        Else
            msg = "The Student Profile was NOT created successfully."
        End If
