Imports System.Data
Partial Class PrintStudentResult
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load


        Dim regRetNumber As String = Request.QueryString("regNo")
        ...
        RetUploadValue = UploadResultDAL.FindAllResultByRegNumber(lblSession1.Text, lblSemester1.Text, lblLevel1.Text, lblRegNumber.Text)

        gdvUploadResult.DataSource = RetUploadValue
        gdvUploadResult.DataBind()

        Dim RetUploadValue2 As DataSet = New DataSet
        Dim RetUploadValue3 As DataSet = New DataSet

        'Handling Carry Over Result loading into CourseRegistraiton_CarryOver Table
        Dim Semester As String = ""

        If lblSemester1.Text = "HND 2 First Semester" Then
            Semester = "HND 1 First Semester"
        ElseIf lblSemester1.Text = "HND 2 Second Semester" Then
            Semester = "HND 1 Second Semester"
        ElseIf lblSemester1.Text = "ND 2 First Semester" Then
            Semester = "ND 1 First Semester"
        ElseIf lblSemester1.Text = "ND 2 Second Semester" Then
            Semester = "ND 1 Second Semester"
        End If

        'Carry Result
        'RetUploadValue2 = UploadResultDAL.FindAllResultByRegNumber_CarryOver(lblSession1.Text, lblSemester1.Text, lblLevel1.Text, lblRegNumber.Text)
        'If RetUploadValue2.Tables(0).Rows.Count = 0 Then
        '    RetUploadValue3 = UploadResultDAL.FindAllResultByRegNumber_CarryOver_Temp(lblSession1.Text, Semester, lblLevel1.Text, lblRegNumber.Text)
        '    If RetUploadValue3.Tables(0).Rows.Count > 0 Then

        '        PnlCarryOver.Visible = True
        '        lblMsg_CarryOver.Text = Semester

        '        gdvUploadResult1.DataSource = RetUploadValue3
        '        gdvUploadResult1.DataBind()
        '    End If

        '    Exit Sub
        'End If
        
        RetUploadValue2 = UploadResultDAL.FindAllResultByRegNumber(lblSession1.Text, Semester, lblLevel1.Text, lblRegNumber.Text)
        ...
        If RetUploadValue2.Tables(0).Rows.Count > 0 Then
            ...
            gdvUploadResult1.DataSource = RetUploadValue2
            gdvUploadResult1.DataBind()
        End If
