<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PrintStudentResult.aspx.vb" Inherits="PrintStudentResult" %>
                                ...
                                <table cellpadding ="3" cellspacing ="3" align="center" width="100%" class="BorderLine">
                                    ...
                                    <tr>
                                        <td align="left" width="47%" valign="top">
                                                        ...
                                                        <td align="center">
                                                          <div id="content_Result">
				                                                            ...
				                                                            <div class="box">
					                                                            <!-- Box Head -->
					                                                            <div class="box-head">
						                                                            <h2 class="left"><asp:Label ID="lblMsg" runat="server" Text=""></asp:Label> Result </h2>
                                                    ...
                                                    <asp:Panel ID="PnlCarryOver" runat="server" Width="100%" Visible="false">
                                                                 <tr>
                                                                    <td align="center">
                                                                      <div id="content_Result">
				                                                            ...
				                                                            <div class="box">
					                                                            <!-- Box Head -->
					                                                            <div class="box-head">
						                                                            <h2 class="left"><asp:Label ID="lblMsg_CarryOver" runat="server" Text=""></asp:Label>  Carry Over Result </h2>
					                                                            ...
					                                                            <!-- Table -->
					                                                            <div class="table">
						                                                             <asp:GridView ID="gdvUploadResult1" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="3" 
                                                                                          AllowPaging="true" CssClass="Grid" AlternatingRowStyle-CssClass="odd" GridLines="None" BorderStyle="None">
                                                                                                     <Columns>
                                                                                                           <asp:BoundField DataField="CourseCode" HeaderText="Course Code" SortExpression="CourseCode" />
                                                                                                           <asp:BoundField DataField="CourseName" HeaderText="Course Name" SortExpression="CourseName" />
                                                                                                           <asp:BoundField DataField="CreditUnit" HeaderText="Credit Unit" SortExpression="CreditUnit" />
