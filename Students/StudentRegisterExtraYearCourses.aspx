<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Students/StudentMasterPage.master" CodeFile="StudentRegisterExtraYearCourses.aspx.vb" Inherits="Students_StudentRegisterExtraYearCourses" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (delconfirm == 'YES') {
                ...
                $.ajax({
                    ...
                    url: "StudentRegisterExtraYearCourses.aspx/GetAllCourses",
                    ...
                    success: function (data) {
                        ...
                        $('#btnDelete').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "StudentRegisterExtraYearCourses.aspx/DeleteCourse",
            ...
            $('#btnSearch').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "StudentRegisterExtraYearCourses.aspx/GetCourse",
                        ...
                        $('#btnRegister').click(function () {
                            $("input:checked").each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    contentType: "application/json; charset=utf-8",
                                    url: "StudentRegisterExtraYearCourses.aspx/RegisterCourses",
            ...
            $('#btnSearch2').click(function () {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "StudentRegisterExtraYearCourses.aspx/GetAllAddCourses",
        ...
        function GCM_Send() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "StudentRegisterExtraYearCourses.aspx/GCM_Send",
