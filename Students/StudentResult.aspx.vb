...
Partial Class Students_StudentResult
    ...
    Public Shared Function FindAllResult(ByVal RegistrationNumber As String, ByVal PIN As String, ByVal SessionName As String, ByVal SemesterName As String, ByVal SessionID As String, ByVal SemesterID As String) As ArrayList
        ...
        Dim RetValue1 As String() = LoadUploadResultDAL.LoadingResult(LoadUploadResultData)
        ...
        'Checking for incomplete Courses
        Dim RetValueString As String = UploadResultDAL.FindIncompleteRegisteredCourses(SessionName, SemesterName, LevelName, RegNumber)

        If RetValueString <> "" Then
            Msg.Add(New FetchResultArrayData("ERROR", RetValueString, "", "", "", ""))
            Return Msg
            Exit Function
        End If
        'call Upload student credential API
        'RetUploadValue = UploadResultDAL.FindAllResultByRegNumber(SessionName, SemesterName, LevelName, RegNumber)
        ...
        Msg = UploadResultDAL.FindAllResultByRegNumber_Load(SessionName, SemesterName, LevelName, RegNumber)

        Return Msg
    End Function
    <WebMethod()> _
    Public Shared Function FindAllCarryOverResult(ByVal RegistrationNumber As String, ByVal PIN As String, ByVal SessionName As String, ByVal SemesterName As String, ByVal SessionID As String, ByVal SemesterID As String) As ArrayList
        Dim Msg As New ArrayList
        ...
        'Setting Carry Over semester
        Dim Semester As String = ""

        If SemesterName = "HND 2 First Semester" Then
            Semester = "HND 1 First Semester"
        ElseIf SemesterName = "HND 2 Second Semester" Then
            Semester = "HND 1 Second Semester"
        ElseIf SemesterName = "ND 2 First Semester" Then
            Semester = "ND 1 First Semester"
        ElseIf SemesterName = "ND 2 Second Semester" Then
            Semester = "ND 1 Second Semester"
        End If

        'Intantiate objects for accessing Result Data and Dal
        Dim UploadResultDAL As UploadResultDAL = New UploadResultDAL
        Msg = UploadResultDAL.FindAllResultByRegNumber_Load(SessionName, Semester, LevelName, RegNumber)
    ...
    Public Shared Function GCM_Send(ByVal regNumber As String) As String
        ...
        Dim msg As String = FullName & " with Reg. Number " & newRegNumber & " have a problem while checking his/her result. Call him/her with this Phone Number " & PhoneNumber
