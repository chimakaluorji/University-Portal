<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ApplicationForm.aspx.vb" Inherits="Application_ApplicationForm" %>
...
<head>
    ...
    <title>Heritage Poly | Application Form</title>
...
<body>
                        ...
                        <div class="ibox-content" id="mainPage">
                            ...
                            <div class="new_step-content" id="Step1">
                                <div class="text-center m-t-md">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Programme Applied For: </label>
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Middle Name (If Any): </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Maiden Name (If Married): </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Home Town/Village: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Next of Kin Relationship: </label>
                                        <div class="col-lg-10">
                            ...
                            <div class="new_step-content" id="Step2" style="display: none;">
                                <div class="text-center m-t-md">
                                    ...
                                    <div id="hnd" style="display: none;">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Name of Institution: </label>
                                            <div class="col-lg-10">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Year of Admission: </label>
                                            <div class="col-lg-10">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Mode of Admission: </label>
                                            <div class="col-lg-10">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Grade of Pass: </label>
                                            <div class="col-lg-10">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Special Field of Study: </label>
                                            <div class="col-lg-10">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Professional Certificates: </label>
                                            <div class="col-lg-10">
                            ...
                            <div class="new_step-content" id="Step3" style="display: none;">
                                <div class="text-center m-t-md">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Academic Distinctions and Prizes: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Employments since leaving college with dates: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Name of First Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Position of First Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Address of First Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Name of Second Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Position of Second Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Address of Second Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Name of Third Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Position of Third Referee: </label>
                                        <div class="col-lg-10">
                                    ...
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Address of Third Referee: </label>
                                        <div class="col-lg-10">
                            ...
                            <div class="new_step-content" id="Step4" style="display: none;">
                                <div class="form-group">
                                    <div class="col-lg-12" id="success" style="display: none;">
                                        <div class="alert alert-success">
                                            Your Application Form was successfully Created, you will be redirect to your account page in 3 seconds.
                                        </div>
                                    </div>

                                    <div class="col-lg-12" id="danger" style="display: none;">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12" style="color: #F25926; font-size: 15px; display: none; text-align: center;" id="spinner">
                                        ...
                                        Please wait, the system is saving application ........
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <b>YOU ARE ALMOST THROUGH, PLEASE, READ THE MESSAGES BELOW AND THEN CONTINUE WITH YOUR APPLICATION</b>
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div>&nbsp;</div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        When you click on the button <b>"Save and Login"</b> button below, your application will be saved and you will be automatically login to your new account.
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        Your Application Number will be automatically generated for you immediately you login into your account by clicking <b>"Save and Login"</b> button below. You can use this Application Number to re-login in future.
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        Immediately you login, ensure you upload your passport photography and a scan copy of your payment evidence (Bank Teller). Your application will be mark invalid if you fail to upload your passport photography and a scan copy of your payment evidence (Bank Teller).
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        Make the payment of<b> ₦10, 000.00 (Ten thousand naria)</b> only to this <b>Account Number: 0122528969, Account Name: Heritage Polytechnic and Bank: Wema Bank.</b>
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        You can view and edit your application form when you login. You can also access your account again using your Application Number.
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        When you login and you are satisfied with all your records, please, lock your data for processing. Your application will be invalid if you do not lock your data, and you will not be able to edit your application after locking your data.
                                    </div>
                                </div>
                                <div>&nbsp;</div>
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        Finally, clicking <b>"Save and Login"</b> button means you have declare that the particulars which I have supplied above are true to the best of my knowledge and belief.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $(document).on("change", "[id*=ddlAppliedProgramme]", function () {
        ...
        $(function () {
            $('#btnSave').click(function () {
                ...
                $.ajax({
                    ...
                    url: "ApplicationForm.aspx/InsertData",
                    data: "{'AppliedProgramme':'" + AppliedProgramme + "','SessionID':'" + SessionID + "','ProgrammeID':'" + ProgrammeID + "','Surname':'" + Surname + "',"
                            ...
                            + "'NameThirdReferee':'" + NameThirdReferee + "','PositionThirdReferee':'" + PositionThirdReferee + "','AddressThirdReferee':'" + AddressThirdReferee + "','DoB':'" + DoB + "'}",
                    dataType: "json",
                    success: function (data) {
                        ...
                        function redirect() {
                            window.location.replace('Notification.aspx?ApNo=' + check);
                        };
