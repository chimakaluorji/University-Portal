<%@ Page Language="VB" MasterPageFile="~/Application/StudentMasterPage.master" AutoEventWireup="false" CodeFile="UploadPicture.aspx.vb" Inherits="Application_UploadPicture" %>
   ...
   <link href="css/plugins/steps/jquery.steps.css" rel="stylesheet">
    ...
    <link href="DropzoneJs_scripts/dropzone.css" rel="stylesheet" />
     ...
     <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Upload Applicant Picture</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="Default.aspx">Applicant</a>
                </li>

                <li class="active">
                    <strong>Upload Applicant Picture</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Upload Applicant Picture</h5>
                                        <br />
                                                                     ...
                                                                     <div class="col-lg-10">
                                                                        <div style="padding: 0 10px 0 10px;">
                                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                ...
                                                                                <div>
                                                                                    <span class="btn btn-success btn-file"><span class="fileinput-new">Select Applicant Passport</span>
         ...
         $('#btnUploadPicture').click(function () {
             ...
             $.ajax({
                 ...
                 success: function (result) {
                     ...
                     if (PhotoUrl == '~/ApplicantsPassport/') {
                     ...
                     $.ajax({
                         ...
                         url: "UploadPicture.aspx/UploadPicture",
                         data: "{'ApplicationNumber':'" + ApplicationNumber + "','PhotoUrl':'" + PhotoUrl + "'}",
                         dataType: "json",
